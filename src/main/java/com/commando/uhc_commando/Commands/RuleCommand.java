    ...
    public boolean rule(CommandSender sender, String[] args) {
        ...
        switch (page){
            case 1:
                ...
                sender.sendMessage("> §3When you §lkill §r§3a §eplayer §3all their §ateams §3join yours");
            ...
            case 3:
                ...
                sender.sendMessage("> §3Time before the Pvp: §e"+ TIME_BEFORE_PVP + " §3minute(s)");
                sender.sendMessage("> §3Border size: §e"+ BORDER_START_SIZE);
                sender.sendMessage("> §3Time before the border starts moving: §e"+ TIME_BEFORE_BORDER_MOVE + " §3minute(s)");
            ...
            case 4:
                ...
                sender.sendMessage("> §3Level 2 potion: "+ LEVEL_TWO_POTION);
            ...
            case 5:
                ...
                sender.sendMessage("> §3Horse: "+ HORSE);
